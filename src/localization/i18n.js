/* ================================================================
   ...
   Contains localized UI, tutorial, story, and music strings. Keep
   gameplay-facing copy aligned with implemented mechanics.
   ================================================================ */
...
export const LANG = {
  en: {
    ...
    tutExit:'EXIT',
    tutorialNext:'NEXT →',
    tutorialWorld1Label:'WORLD 1: GENESIS',
    tutorialWorld2Label:'WORLD 2: THE VOID',
    tutorialWorld3Label:'WORLD 3: NEXUS PRIME',
    viewEnding:'VIEW',
    notifNowPlaying:'NOW PLAYING',
    notifSignalTowerTitle:'SIGNAL TOWER',
    notifSignalTowerBody:'Full-map reveal online for 8 seconds.',
    notifAiRetreatTitle:'AI RETREATING',
    notifAiRetreatBody:'Enemy pressure has shifted into a defensive posture.',
    notifHintKicker:'FIELD TIP',
    hintExpandTitle:'Secure a second cell',
    hintExpandBody:'Open with a nearby neutral so your network stops depending on a single source.',
    hintSliceTitle:'Slice wins tempo',
    hintSliceBody:'Cut near the source for burst, in the middle for a split, and near the target for a defensive refund.',
    hintSupportTitle:'Support the pressured lane',
    hintSupportBody:'Send energy from a safer rear cell so the frontline keeps fighting and still levels up.',
    hintRelayTitle:'Take the relay first',
    hintRelayBody:'Owned relays amplify outgoing flow. Capturing one early often decides the whole lane.',
    hintPulsarTitle:'Play around the pulsar',
    hintPulsarBody:'Keep owned non-relay cells inside the pulsar radius before the next pulse for free energy.',
    hintPressureTitle:'Punish the weak node',
    hintPressureBody:'When an enemy cell is overextended or low on energy, focus it before the lane stabilizes.',
    notifDebugSnapshotCopiedTitle:'SNAPSHOT COPIED',
    notifDebugSnapshotCopiedBody:'Runtime diagnostics are now on the clipboard.',
    notifProgressResetTitle:'PROGRESS RESET',
    notifProgressResetBody:'Campaign completion and stars were cleared.',
    trackDriftSignal:'DRIFT SIGNAL',
    trackGenesisPulse:'GENESIS PULSE',
    trackSiegeBloom:'SIEGE BLOOM',
    trackEchoCore:'ECHO CORE',
    trackHollowSignal:'HOLLOW SIGNAL',
    trackEntropyCurrent:'ENTROPY CURRENT',
    trackOblivionGate:'OBLIVION GATE',
    trackCurrent:'CURRENT',
    trackSignalWar:'SIGNAL WAR',
    trackTranscendenceProtocol:'TRANSCENDENCE PROTOCOL',
    trackNetworkAwakens:'THE NETWORK AWAKENS',
    trackStella:'STELLA',
    trackAqueous:'AQUEOUS',
    trackRoleMenu:'A calm drift through the sleeping grid.',
    trackRoleWorld1Opening:'The feeling of first growth, open air, and brave expansion.',
    trackRoleWorld1Pressure:'Bright confidence pushing through the front line.',
    trackRoleWorld2Opening:'Cold distance, careful routes, and quiet courage in the dark.',
    trackRoleWorld2Pressure:'Forward motion through danger, with beauty hidden inside the storm.',
    trackRoleWorld3Opening:'Charged focus, clean intent, and momentum gathering through the network.',
    trackRoleWorld3Pressure:'A rising current of pressure, ambition, and sharpened control.',
    trackRoleWorld3Finale:'The last surge before the system finally bends.',
    trackRoleBoss:'A decisive heartbeat before the map gives way.',
    trackRoleEnding:'Relief, reunion, and the feeling of a living network made whole.',
    trackRoleBonusStella:'Weightless, bright, and restless — like looking up and deciding to keep going.',
    trackRoleBonusAqueous:'Fast, fluid, and wide-open — like motion that never stops long enough to sink.',
    ...
    setShowFps:'⌁ FPS MONITOR', setShowFpsDesc:'Show the live frame rate in the HUD during play',
    ...
    setSfx:'✦ SOUND EFFECTS', setSfxDesc:'Procedural combat, capture, and interface feedback audio',
    setMusic:'♫ MUSIC', setMusicDesc:'Adaptive soundtrack grouped across menu, worlds, bosses, and ending',
    setMusicPlayer:'♫ SOUNDTRACK PLAYER', setMusicPlayerDesc:'Preview grouped tracks without leaving settings',
    setMusicPlay:'▶ PLAY', setMusicPause:'⏸ PAUSE', setMusicCurrentIdle:'No track selected',
    setFont:'✎ UI FONT', setFontDesc:'Apply the selected typeface across menus and canvas labels',
    setZoom:'⌕ TEXT SIZE', setZoomDesc:'Scale interface readability from 50% to 200%',
    setLang:'🌐 LANGUAGE', setLangDesc:'Switch all interface and story text between Portuguese and English',
    setTheme:'🎨 THEME', setThemeDesc:'Switch the full interface art direction',
    setGameMode:'◈ GAME MODE', setGameModeDesc:'Switch between the stable live mode and the TentacleWars prototype track',
    setDebug:'⚡ DEBUG MODE', setDebugDesc:'All levels unlocked · Shows hidden info',
    setCopyDebug:'⎘ COPY SNAPSHOT', setCopyDebugDesc:'Copy the current runtime diagnostics to the clipboard',
    setViewEnding:'◈ VIEW CAMPAIGN ENDING', setViewEndingDesc:'Preview the final epilogue screen without clearing the campaign',
    setReset:'⚠ RESET PROGRESS', setResetDesc:'Erase campaign completion, stars, and stored progression flags',
    twModeLabel:'TENTACLEWARS',
    twModeComingSoonTitle:'MODE BOUNDARY READY',
    twModeComingSoonBody:'The TentacleWars branch is wired in. The first sandbox prototype lands in TASK-TW-005.',
    twModeComingSoonToast:'TentacleWars mode shell is active. Sandbox prototype coming next.',
    twSandboxName:'TENTACLEWARS SANDBOX',
    twSandboxTitle:'SANDBOX PROTOTYPE ONLINE',
    twSandboxBody:'A randomized TentacleWars validation map is live. Use it to pressure packet flow, overflow, and hostile carryover.',
    twSandboxPauseInfo:name => `SANDBOX — ${name}`,
    twSandboxPauseHint:'Prototype sandbox. Restart freely and return to the menu when you are done testing.',
    twSandboxPauseStatus:'Prototype sandbox finished. Restart to run another validation round.',
    twSandboxWinTitle:'SANDBOX CLEARED',
    twSandboxWinBody:'The prototype sandbox is under control. Restart to test another random layout or return to the menu.',
    twSandboxWinToast:'TentacleWars sandbox cleared.',
    twSandboxLoseTitle:'SANDBOX COLLAPSED',
    twSandboxLoseBody:'The prototype sandbox overran your colony. Restart to validate another attempt.',
    twSandboxLoseToast:'TentacleWars sandbox lost.',
    twWorldLabel:    n => `WORLD ${n}`,
    twWorldPointer:  (id, n) => `CURRENT POINTER ${id} · ${n}/4 WORLDS OPEN`,
    twSelectWorld:   'SELECT WORLD',
    twLocked:        '🔒 LOCKED',
    twLevelPointer:  (w, id) => `WORLD ${w} · CURRENT POINTER ${id}`,
    twEnergyCap:     n => `ENERGY CAP ${n}`,
    twParTime:       n => `PAR ${n}s`,
    twOpeningReady:  'OPENING READY',
    twStars:         'STARS',
    twWorlds:        'WORLDS',
    twNextPhase:     'NEXT PHASE ▶',
    twEndingTitle:   'TENTACLE WARS',
    twEndingSub:     'Campaign complete · 80 phases',
    twEndingMeta:    'World 1 → World 4',
    ...
    obstacleBlocked:'ROUTE BLOCKED BY AN OBSTACLE',
    ...
    tutorialStepsWorld1: [
      ...
      { title:'CAPTURE IN PROGRESS',
        text:'Start the capture and watch the arc around the grey cell begin to fill. Energy travels through the tentacle at a finite speed — you can see the orbs flowing. Once pressure starts, protect the lane and keep expanding.',
        action:'capture', hint:'Begin the capture...' },
    ...
    tutorialStepsWorld2: [
      ...
      { title:'ROUTE AROUND IT',
        ...
        action:'tentacle', hint:'Click or drag to a neutral cell' },
      { title:'CAPTURE!',
        text:'Begin the capture and watch the orbs on your tentacle. If they dim and delivery slows, the vortex is draining your link.<br><br>Tip: <b>shorter routes avoid more vortex exposure</b>. Prioritise captures in safe corridors.',
        action:'capture', hint:'Begin the capture...' },
      { title:'VOID MASTERED',
  ...
  pt: {
    ...
    tutorialWorld1Label:'MUNDO 1: GÊNESIS',
    tutorialWorld2Label:'MUNDO 2: O VAZIO',
    tutorialWorld3Label:'MUNDO 3: NEXO PRIME',
    viewEnding:'VER',
    notifNowPlaying:'TOCANDO AGORA',
    notifSignalTowerTitle:'TORRE DE SINAL',
    notifSignalTowerBody:'Revelação total do mapa por 8 segundos.',
    notifAiRetreatTitle:'IA RECUANDO',
    notifAiRetreatBody:'A pressão inimiga entrou em postura defensiva.',
    notifHintKicker:'DICA DE CAMPO',
    hintExpandTitle:'Garanta uma segunda célula',
    hintExpandBody:'Abra a fase capturando um neutro próximo para sua rede deixar de depender de uma única fonte.',
    hintSliceTitle:'Slice ganha tempo',
    hintSliceBody:'Corte perto da fonte para burst, no meio para split, e perto do alvo para reembolso defensivo.',
    hintSupportTitle:'Sustente a rota pressionada',
    hintSupportBody:'Envie energia de uma célula traseira mais segura para a linha de frente continuar lutando e evoluindo.',
    hintRelayTitle:'Tome o retransmissor primeiro',
    hintRelayBody:'Retransmissores próprios amplificam o fluxo de saída. Capturar um cedo costuma decidir toda a rota.',
    hintPulsarTitle:'Jogue em volta do pulsar',
    hintPulsarBody:'Mantenha células próprias que não sejam retransmissores dentro do raio antes do próximo pulso para ganhar energia grátis.',
    hintPressureTitle:'Puna o nodo fraco',
    hintPressureBody:'Quando uma célula inimiga estiver exposta ou com pouca energia, foque nela antes que a rota estabilize.',
    notifDebugSnapshotCopiedTitle:'SNAPSHOT COPIADO',
    notifDebugSnapshotCopiedBody:'O diagnóstico atual foi copiado para a área de transferência.',
    notifProgressResetTitle:'PROGRESSO RESETADO',
    notifProgressResetBody:'A campanha concluída e as estrelas foram apagadas.',
    trackDriftSignal:'DRIFT SIGNAL',
    trackGenesisPulse:'GENESIS PULSE',
    trackSiegeBloom:'SIEGE BLOOM',
    trackEchoCore:'ECHO CORE',
    ...
    trackStella:'STELLA',
    trackAqueous:'AQUEOUS',
    trackRoleMenu:'Uma deriva serena pela rede adormecida.',
    trackRoleWorld1Opening:'A sensação de primeiro crescimento, espaço aberto e expansão corajosa.',
    trackRoleWorld1Pressure:'Confiança luminosa empurrando a linha de frente.',
    trackRoleWorld2Opening:'Distância fria, rotas cautelosas e coragem silenciosa no escuro.',
    trackRoleWorld2Pressure:'Movimento para frente através do perigo, com beleza escondida dentro da tempestade.',
    trackRoleWorld3Opening:'Foco elétrico, intenção limpa e impulso crescendo pela rede.',
    trackRoleWorld3Pressure:'Uma corrente crescente de pressão, ambição e controle afiado.',
    trackRoleWorld3Finale:'O último avanço antes do sistema enfim ceder.',
    trackRoleBoss:'Uma batida decisiva antes do mapa se render.',
    trackRoleEnding:'Alívio, reencontro e a sensação de uma rede viva enfim inteira.',
    trackRoleBonusStella:'Leve, luminosa e inquieta — como olhar para cima e decidir continuar.',
    trackRoleBonusAqueous:'Rápida, fluida e aberta — como um movimento que nunca para tempo suficiente para afundar.',
    ...
    setShowFps:'⌁ MONITOR DE FPS', setShowFpsDesc:'Mostra a taxa de quadros ao vivo na HUD durante a partida',
    ...
    setSfx:'✦ EFEITOS SONOROS', setSfxDesc:'Áudio procedural de combate, captura e feedback da interface',
    setMusic:'♫ MÚSICA', setMusicDesc:'Trilha adaptativa por menu, mundos, chefes e final',
    setMusicPlayer:'♫ PLAYER DA TRILHA', setMusicPlayerDesc:'Faça preview das trilhas agrupadas sem sair das configurações',
    setMusicPlay:'▶ TOCAR', setMusicPause:'⏸ PAUSAR', setMusicCurrentIdle:'Nenhuma faixa selecionada',
    setFont:'✎ FONTE DA UI', setFontDesc:'Aplica a fonte escolhida nos menus e rótulos do canvas',
    setZoom:'⌕ TAMANHO DO TEXTO', setZoomDesc:'Escala a legibilidade da interface de 50% a 200%',
    setLang:'🌐 IDIOMA', setLangDesc:'Troca todos os textos da interface e história entre Português e English',
    setTheme:'🎨 TEMA', setThemeDesc:'Troca toda a direção visual da interface',
    setGameMode:'◈ MODO DE JOGO', setGameModeDesc:'Alterna entre o modo estável atual e a trilha protótipo de TentacleWars',
    setDebug:'⚡ MODO DEBUG', setDebugDesc:'Todos os níveis desbloqueados · Mostra info oculta',
    setCopyDebug:'⎘ COPIAR SNAPSHOT', setCopyDebugDesc:'Copia o diagnóstico atual de execução para a área de transferência',
    setViewEnding:'◈ VER FINAL DA CAMPANHA', setViewEndingDesc:'Abre o epílogo final sem precisar concluir a campanha',
    setReset:'⚠ RESETAR PROGRESSO', setResetDesc:'Apaga campanha concluída, estrelas e flags salvas de progresso',
    twModeLabel:'TENTACLEWARS',
    twModeComingSoonTitle:'FRONTEIRA DO MODO PRONTA',
    twModeComingSoonBody:'A trilha separada de TentacleWars já está conectada. O primeiro sandbox chega na TASK-TW-005.',
    twModeComingSoonToast:'A estrutura do modo TentacleWars está ativa. O sandbox vem na próxima wave.',
    twSandboxName:'SANDBOX TENTACLEWARS',
    twSandboxTitle:'SANDBOX PROTÓTIPO ONLINE',
    twSandboxBody:'Um mapa randômico de validação TentacleWars está ativo. Use-o para testar fluxo por pacotes, overflow e carryover hostil.',
    twSandboxPauseInfo:name => `SANDBOX — ${name}`,
    twSandboxPauseHint:'Sandbox de protótipo. Reinicie livremente e volte ao menu quando terminar de testar.',
    twSandboxPauseStatus:'Sandbox de protótipo concluído. Reinicie para validar outra rodada.',
    twSandboxWinTitle:'SANDBOX CONCLUÍDO',
    twSandboxWinBody:'O sandbox protótipo ficou sob controle. Reinicie para testar outro layout randômico ou volte ao menu.',
    twSandboxWinToast:'Sandbox TentacleWars concluído.',
    twSandboxLoseTitle:'SANDBOX COLAPSOU',
    twSandboxLoseBody:'O sandbox protótipo dominou sua colônia. Reinicie para validar outra tentativa.',
    twSandboxLoseToast:'Sandbox TentacleWars perdido.',
    twWorldLabel:    n => `MUNDO ${n}`,
    twWorldPointer:  (id, n) => `PONTEIRO ATUAL ${id} · ${n}/4 MUNDOS ABERTOS`,
    twSelectWorld:   'SELECIONAR MUNDO',
    twLocked:        '🔒 BLOQUEADO',
    twLevelPointer:  (w, id) => `MUNDO ${w} · PONTEIRO ATUAL ${id}`,
    twEnergyCap:     n => `ENERGIA MÁX ${n}`,
    twParTime:       n => `PAR ${n}s`,
    twOpeningReady:  'FASE DISPONÍVEL',
    twStars:         'ESTRELAS',
    twWorlds:        'MUNDOS',
    twNextPhase:     'PRÓXIMA FASE ▶',
    twEndingTitle:   'TENTACLE WARS',
    twEndingSub:     'Campanha concluída · 80 fases',
    twEndingMeta:    'Mundo 1 → Mundo 4',
    ...
    obstacleBlocked:'ROTA BLOQUEADA POR OBSTÁCULO',
    ...
    tutorialStepsWorld1: [
      ...
      { title:'CAPTURA EM ANDAMENTO',
        text:'Inicie a captura e observe o arco ao redor da célula cinza começar a se preencher. A energia viaja em velocidade finita — veja os orbs fluindo. Assim que a pressão começar, proteja a rota e continue expandindo.',
        action:'capture', hint:'Inicie a captura...' },
    ...
    tutorialStepsWorld2: [
      ...
      { title:'DESVIE DELE',
        ...
        action:'tentacle', hint:'Clique ou arraste até uma célula neutra' },
      { title:'CAPTURE!',
        text:'Inicie a captura e observe os orbs no tentáculo. Se escurecerem e a entrega diminuir, o vórtice está drenando o link.<br><br>Dica: <b>rotas mais curtas evitam mais exposição ao vórtice</b>. Priorize capturas em corredores seguros.',
        action:'capture', hint:'Inicie a captura...' },
