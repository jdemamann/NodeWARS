...
export const LANG = {
  en: {
    ...
    notifMusicMeta:(bpm, duration) => `${bpm} BPM · LOOP ${duration}`,
    ...
    trackRoleMenu:'Sacred menu loop · low-pressure system drift',
    trackRoleWorld1Opening:'World 1 opening cadence · expansion and first contact',
    trackRoleWorld1Pressure:'World 1 pressure cadence · siege lanes and mid-map control',
    trackRoleWorld2Opening:'World 2 opening cadence · cautious routing through the Void',
    trackRoleWorld2Pressure:'World 2 pressure cadence · drain fields and unstable corridors',
    trackRoleWorld3Opening:'World 3 opening cadence · relay routes and pulse timing',
    trackRoleWorld3Pressure:'World 3 pressure cadence · coalition pressure and signal warfare',
    trackRoleWorld3Finale:'Final assault cadence · coalition collapse and system takeover',
    trackRoleBoss:'Boss cadence · decisive lane control and kill-confirm pressure',
    trackRoleEnding:'Epilogue cadence · the network breathes as one body',
  ...
  pt: {
    ...
    trackTranscendenceProtocol:'TRANSCENDENCE PROTOCOL',
    trackNetworkAwakens:'THE NETWORK AWAKENS',
    trackRoleMenu:'Loop sagrado do menu · deriva sistêmica de baixa pressão',
    trackRoleWorld1Opening:'Cadência inicial do Mundo 1 · expansão e primeiro contato',
    trackRoleWorld1Pressure:'Cadência de pressão do Mundo 1 · cerco e controle do miolo',
    trackRoleWorld2Opening:'Cadência inicial do Mundo 2 · rotas cautelosas pelo Vazio',
    trackRoleWorld2Pressure:'Cadência de pressão do Mundo 2 · campos de drenagem e corredores instáveis',
    trackRoleWorld3Opening:'Cadência inicial do Mundo 3 · rotas de relay e timing de pulsar',
    trackRoleWorld3Pressure:'Cadência de pressão do Mundo 3 · coalizão inimiga e guerra de sinal',
    trackRoleWorld3Finale:'Cadência do assalto final · colapso da coalizão e tomada do sistema',
    trackRoleBoss:'Cadência de chefe · controle decisivo de rotas e finalização de alvos',
    trackRoleEnding:'Cadência de epílogo · a rede volta a respirar como um único corpo',
