...
export const LANG = {
  en: {
    ...
    tutExit:'EXIT',
    viewEnding:'VIEW',
    endingKicker:'CAMPAIGN COMPLETE',
    endingTitle:'THE NETWORK AWAKENS',
    endingSubtitle:'Genesis has been reunified. The Void has been crossed. Nexus Prime now breathes under your pattern.',
    endingSubtitleDebug:'Debug preview of the campaign epilogue.',
    endingWorlds:'WORLDS RECLAIMED',
    endingCuts:'TOTAL CUTS',
    endingFrenzies:'FRENZIES',
    endingTime:'FINAL PHASE TIME',
    endingScore:'FINAL SCORE',
    endingQuote:'"No longer isolated cells. One living network."',
    endingStory:[
      'You did not win by extinguishing the network. You won by teaching it to flow again. Where the Bioplex had splintered into starving fragments, your lines reconnected pressure, growth, and memory.',
      'Genesis was not merely conquered. It was stabilized. The Void was not merely survived. It was crossed and made navigable. Nexus Prime was not simply broken. Its relays, signals, and pulsars now answer to a single living pattern.',
      'The NEXUS HIVE falls not because everything is silent, but because the system breathes as one body again. Across every reclaimed lane, the network now carries only one command: continue.',
    ],
    /* Settings labels */
    ...
    setViewEnding:'VIEW CAMPAIGN ENDING', setViewEndingDesc:'Preview the final epilogue screen without beating the campaign',
  ...
  pt: {
    ...
    tutExit:'SAIR',
    viewEnding:'VER',
    endingKicker:'CAMPANHA CONCLUÍDA',
    endingTitle:'A REDE DESPERTA',
    endingSubtitle:'Gênesis foi reunificada. O Vazio foi atravessado. O Nexo Prime agora respira sob o seu padrão.',
    endingSubtitleDebug:'Pré-visualização debug do epílogo da campanha.',
    endingWorlds:'MUNDOS RETOMADOS',
    endingCuts:'CORTES TOTAIS',
    endingFrenzies:'FRENZIES',
    endingTime:'TEMPO DA FASE FINAL',
    endingScore:'PONTUAÇÃO FINAL',
    endingQuote:'"Não mais células isoladas. Uma única rede viva."',
    endingStory:[
      'Você não venceu apagando a rede. Venceu ensinando-a a fluir de novo. Onde o Bioplex havia se partido em fragmentos famintos, suas linhas reconectaram pressão, crescimento e memória.',
      'Gênesis não foi apenas conquistada. Foi estabilizada. O Vazio não foi apenas sobrevivido. Foi atravessado e tornado navegável. O Nexo Prime não foi simplesmente quebrado. Seus retransmissores, sinais e pulsares agora respondem a um único padrão vivo.',
      'O NEXUS HIVE cai não porque tudo ficou em silêncio, mas porque o sistema voltou a respirar como um só corpo. Em cada rota retomada, a rede agora carrega apenas um comando: continuar.',
    ],
    /* Settings labels */
    ...
    setViewEnding:'VER FINAL DA CAMPANHA', setViewEndingDesc:'Abre o epílogo final sem precisar concluir a campanha',
