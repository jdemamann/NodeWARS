...
export const LANG = {
  en: {
    ...
    stor: [
      ...
      { p:'<b style="color:#00e5ff">◈ Relay Nodes</b> — capturable nodes that amplify every tentacle sent through them by +45%. Whoever controls the Relays controls the flow of the entire battlefield.<br><br><b style="color:#ff9020">⚡ Pulsars</b> — neutral beacons that periodically broadcast energy to all nearby cells. Position your network within their radius, and you receive free power every 4.5 seconds — a tide that turns the war.' },
    ...
    tut: [
      ...
      { title:'SEND A TENTACLE',
        text:'With your cell selected, <b>click a neutral grey cell</b>. A tentacle grows toward it. Notice: <b>energy only starts flowing after the tip fully connects</b> — there is a travel delay.',
        action:'tentacle', hint:'Click a neutral cell' },
      ...
      { title:'RETRACT A TENTACLE',
        text:'<b>Click your cell again</b> (the sending cell) to retract all its tentacles. You recover most of the build cost. Retracting from a full cell returns more energy than from an empty one.',
        action:'retract', hint:'Click your cell again' },
      { title:'THE CUT — YOUR BLADE',
        text:'Send a new tentacle. Then <b>right-click and drag</b> a line across it to cut it.<br><br>⚡ <b>Key mechanic:</b> cut near the <i>target</i> to burst-deliver energy. Cut near the <i>source</i> to recover energy.',
        action:'cut', hint:'Right-drag across the tentacle' },
      { title:'FRENZY MODE',
        text:'<b>Cut 3 tentacles within 1.5 seconds</b> to trigger ⚡ FRENZY — all your cells get +35% regen for 4 seconds. A golden bar pulses on screen.<br><br>This is your most powerful burst tactic.',
        action:'read' },
      { title:'ENERGY CASCADE',
        text:'When a cell is <b>full (250 energy)</b>, overflow automatically cascades through its tentacles to connected cells. Build networks to charge your frontline faster.<br><br>A gold shimmer shows when a cell is overflowing.',
        action:'read' },
    ...
    tut2: [
      ...
      { title:'ROUTE AROUND IT',
        text:'<b>Select your cell and send a tentacle to a neutral cell.</b> Try to reach one that is NOT blocked by the vortex. If your route passes through it, you will see the orbs dim and energy delivery slow down.',
        action:'tentacle', hint:'Click a neutral cell' },
      { title:'CAPTURE!',
    ...
    tut3: [
      ...
      { title:'CAPTURE THE RELAY',
        text:'<b>Select your cell and capture the Relay node</b> (the hexagonal one). Once you own it, use it as a forward base — send tentacles from it to reach distant cells with a massive flow advantage.',
        action:'capture_relay', hint:'Capture the Relay node' },
      { title:'PULSAR BEACONS',
        text:'The <b style="color:#ff9020">orange beacon</b> is a Pulsar. Every 4.5 seconds it <b>broadcasts energy to all cells within its radius</b>.<br><br>⚡ Watch for the charge animation — a ring growing around it — then the burst wave spreading outward.',
        action:'read' },
      { title:'NEXUS PRIME MASTERED',
        text:'You control the fundamentals of Nexus Prime. Strategy tip:<br><br><b>Capture relays early</b> to establish high-efficiency corridors. <b>Position your cells inside pulsar radius</b> for free energy every 4.5 seconds.<br><br>Use both to overwhelm the AI.',
        action:'done' },
    ],
  },
  ...
  pt: {
    ...
    stor: [
      ...
      { p:'<b style="color:#00e5ff">◈ Retransmissores</b> — nós capturáveis que amplificam cada tentáculo enviado por eles em +45%. Quem controla os Retransmissores controla o fluxo de todo o campo de batalha.<br><br><b style="color:#ff9020">⚡ Pulsares</b> — balizas neutras que periodicamente transmitem energia para todas as células próximas. Posicione sua rede dentro do raio deles e receba energia gratuita a cada 4,5 segundos — uma maré que muda a guerra.' },
    ...
    tut: [
      ...
      { title:'ENVIE UM TENTÁCULO',
        text:'Com sua célula selecionada, <b>clique em uma célula neutra cinza</b>. Um tentáculo cresce até ela. Atenção: <b>a energia só flui depois que a ponta se conecta</b> — há um atraso de percurso.',
        action:'tentacle', hint:'Clique em uma célula neutra' },
      ...
      { title:'RECOLHA UM TENTÁCULO',
        text:'<b>Clique novamente na sua célula</b> para recolher todos os tentáculos. Você recupera a maior parte do custo de construção. Recolher de uma célula cheia devolve mais energia.',
        action:'retract', hint:'Clique novamente na sua célula' },
      { title:'O CORTE — SUA LÂMINA',
        text:'Envie um novo tentáculo. Depois <b>clique com o botão direito e arraste</b> uma linha sobre ele para cortá-lo.<br><br>⚡ <b>Mecânica-chave:</b> corte perto do <i>alvo</i> para disparar energia. Corte perto da <i>fonte</i> para recuperar energia.',
        action:'cut', hint:'Arraste o botão direito sobre o tentáculo' },
      { title:'MODO FRENZY',
        text:'<b>Corte 3 tentáculos em 1,5 segundo</b> para ativar ⚡ FRENZY — todas as suas células ganham +35% de regen por 4 segundos. Uma barra dourada pulsa na tela.<br><br>Esta é sua tática de explosão mais poderosa.',
        action:'read' },
      { title:'CASCATA DE ENERGIA',
        text:'Quando uma célula está <b>cheia (250 de energia)</b>, o excedente flui automaticamente pelos tentáculos para células conectadas. Construa redes para carregar a linha de frente mais rápido.<br><br>Um brilho dourado indica quando a célula está transbordando.',
        action:'read' },
    ...
    tut2: [
      ...
      { title:'O VÓRTICE',
        ...
        action:'read' },
      { title:'DESVIE DELE',
        text:'<b>Selecione sua célula e envie um tentáculo para uma célula neutra.</b> Tente alcançar uma que NÃO seja bloqueada pelo vórtice. Se a rota passar por ele, os orbs escurecerão e a entrega de energia diminuirá.',
        action:'tentacle', hint:'Clique em uma célula neutra' },
      { title:'CAPTURE!',
    ...
    tut3: [
      ...
      { title:'CAPTURE O RETRANSMISSOR',
        text:'<b>Selecione sua célula e capture o nó Retransmissor</b> (o hexagonal). Depois use-o como base avançada — envie tentáculos a partir dele para alcançar células distantes com enorme vantagem de fluxo.',
        action:'capture_relay', hint:'Capture o Retransmissor' },
      { title:'PULSARES',
        text:'A <b style="color:#ff9020">baliza laranja</b> é um Pulsar. A cada 4,5 segundos ele <b>transmite energia para todas as células dentro do raio</b>.<br><br>⚡ Observe a animação de carga — um anel crescendo ao redor — e então a onda de pulso se expandindo.',
        action:'read' },
      { title:'NEXO PRIME DOMINADO',
        text:'Você controla os fundamentos do Nexo Prime. Dica estratégica:<br><br><b>Capture retransmissores cedo</b> para criar corredores de alta eficiência. <b>Posicione suas células dentro do raio do pulsar</b> para energia grátis a cada 4,5 segundos.<br><br>Use ambos para esmagar a IA.',
        action:'done' },
    ],
  },
};
